...
mithCreateCommentHtml(text,
   ...
   var html = '<div class="commentTable">\n';
   html +=    '<table width=\'100%\' cellspacing=\'0\' align=\'center\'>\n';
   html +=    '<tr>\n';
   ...
   html +=    '<\/fb:name>\n';
   html +=    '<span class="date">'+ timestamp +'<\/span>\n';
   html +=    '<div class="commentTextOld">'+ text +'<\/div>\n';
   html +=    '<\/td>\n';
   html +=    '<\/tr>\n';
   html +=    '<\/table>\n'
   html +=    '<\/div>'
